    ...
    return (
        ...
        <div className="p-10 flex flex-wrap">
            <div className="w-100pc md-w-50pc">
                <div className="p-5">
                    <h4 className="white fw-800 fs-l3 mb-5">Lorem Pricing</h4>
                    ...
                    <h4 className="white fw-600 fs-m2 mt-10">Companies trusts us.</h4>
                    <div className="flex indigo-lightest opacity-50">
            ...
            <div className="w-100pc md-w-25pc">
                <div className="m-3 p-5 br-8 bg-indigo-lightest-10 overflow-hidden">
                    <div className="p-3">
                        ...
                        <div className="white flex items-center">$<span className="fs-l5 lh-1">0</span>/mo</div>
                    </div>
                    <div className="p-3 indigo-lightest fw-400 fs-s1 lh-5">
                        <div>
                            <i className="h-3 indigo" strokeWidth="4" data-feather="check"></i>
                            <span className="opacity-50">1 user</span>
                        </div>
                        <div>
                            <i className="h-3 indigo" strokeWidth="4" data-feather="check"></i>
                            <span className="opacity-50">100 visitors/month</span></div>
                        <div>
                            <i className="h-3 indigo" strokeWidth="4" data-feather="check"></i>
                            <span className="opacity-50">1 website</span></div>
                        <div>
                            <i className="h-3 indigo" strokeWidth="4" data-feather="check"></i>
                            <span className="opacity-50">24x7 support</span></div>
                        <div>
                            <i className="h-3" strokeWidth="4" data-feather="x"></i>
                            <span className="opacity-50">third party integration</span></div>
                    </div>
                    <div className="p-3">
                        <button className="button full bg-black white  hover-opacity-100 hover-scale-up-1 ease-300">SIGN
                            UP</button>
                    </div>
                </div>
            </div>
            <div className="w-100pc md-w-25pc">
                <div className="m-3 p-5 br-8 bg-white overflow-hidden">
                    <div className="p-3">
                        ...
                        <div className="black flex items-center">$<span className="fs-l5 lh-1">99</span>/mo</div>
                    </div>
                    <div className="p-3 black fw-400 fs-s1 lh-5">
                        <div>
                            <i className="h-3 indigo" strokeWidth="4" data-feather="check"></i>
                            <span className="opacity-50"> 5 user</span></div>
                        <div>
                            <i className="h-3 indigo" strokeWidth="4" data-feather="check"></i>
                            <span className="opacity-50">10,000 visitors/month</span></div>
                        <div>
                            <i className="h-3 indigo" strokeWidth="4" data-feather="check"></i>
                            <span className="opacity-50">3 website</span></div>
                        <div>
                            <i className="h-3 indigo" strokeWidth="4" data-feather="check"></i>
                            <span className="opacity-50">24x7 support</span></div>
                        <div>
                    ...
                    <div className="p-3">
                        <button className="button full bg-indigo white hover-opacity-100 hover-scale-up-1 ease-300">SIGN
                            UP</button>
                    </div>
                </div>
            </div>
